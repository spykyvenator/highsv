...
void search_entry_dwn(GtkButton *BtnUp, GObject *entry);
void search_entry_up(GtkButton *BtnUp, GObject *entry);
void search_disabled(GtkWidget *sb, GtkTextBuffer *buffer);
